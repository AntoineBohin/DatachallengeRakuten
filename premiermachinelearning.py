...
train_csv = pd.read_csv('dataset/processed_and_concatenated_X_Y_train_lolo.csv', index_col=0)

X_tfidf_sample = sparse.load_npz("./dataset/X_consolidated_without_numbers_lolo.npz")
